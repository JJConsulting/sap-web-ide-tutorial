sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("opensap/manageproductsapp/app", ".html");
		...
		return Opa5.extend("opensap.manageproductsapp.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["opensap/manageproductsapp/localService/mockserver"], function (mockserver) {
